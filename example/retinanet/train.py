...
from loss.facal_loss import FocalLoss
from datasets.detdataset import TrainDataset
from models.retinanet import RetinaBoxCoder, RetinaNet
from datasets.transforms import pad, resize, random_flip, random_paste
...
net = RetinaNet(num_classes=60).to(device)
...
criterion = FocalLoss(num_classes=60)
