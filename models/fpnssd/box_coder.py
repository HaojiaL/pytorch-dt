...
from utils.box import meshgrid
...
class FPNSSDBoxCoder:
    def __init__(self):
        ...
        self.aspect_ratios = (1/2., 1/1., 2/1., 3/1., 4/1., 5/1.)
    ...
    def _get_anchor_boxes(self, input_size):
        ...
        for i in range(num_fms):
            ...
            xy = (xy*grid_size).view(fm_h,fm_w,1,2).expand(fm_h,fm_w,18,2)
            wh = anchor_wh[i].view(1,1,18,2).expand(fm_h,fm_w,18,2)
